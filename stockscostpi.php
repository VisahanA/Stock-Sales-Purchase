...
*/			
$setExcelName = "Available Warehouse Products(Quantity)";
$setSql = mysqli_query($con,  "select product_id AS 'PRODUCT ID' ,product_name AS 'PRODUCT NAME', quantity AS 'QUANTITY' from warehouse_details ORDER BY `warehouse_details`.`quantity` ASC");
