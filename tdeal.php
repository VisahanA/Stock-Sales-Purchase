...
$setSql = mysqli_query($con,  "SELECT d_email, SUM(p_stot_cost),MAX(p_stot_cost),MIN(p_stot_cost) FROM t_saletrans INNER JOIN 
                    t_soldprd ON t_saletrans.p_sid=t_soldprd.p_sid group by (d_email) order by sum(p_stot_cost) DESC");
