...
*/			
$setExcelName = "Available Warehouse Products(ProductID)";
$setSql = mysqli_query($con,  "select product_id AS 'PRODUCT ID' ,product_name AS 'PRODUCT NAME', quantity AS 'QUANTITY' from warehouse_details ORDER BY `warehouse_details`.`product_id` ASC");
